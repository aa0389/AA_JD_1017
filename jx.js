...
[task_local]
#jd免费水果
7 7 7 7 7 https://gitee.com/lxk0301/jd_scripts/raw/master/jd_fruit.js, tag=AA_解析CODE, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "6 6 6 6 6" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 5 5 5 5 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_fruit.js
...
const jxCode = process.env.JD_JX_CODE
...
function AAJxCode() {
    return new Promise(async resolve => {
      $.post({url: `https://api.nolanstore.top/JComExchange`,json:{"code":jxCode},timeout: 30000}, (err, resp, data) => {
        try {
          if (err) {
