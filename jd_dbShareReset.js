...
[Script]
cron "0 10 0 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_fruit.js,tag=数据库助力码每天重置


export DO_TEN_WATER_AGAIN = "" 默认再次浇水
*/
const $ = new Env('数据库助力码每天重置');
...
!(async () => {
 ...
 function getAAShareCode() {
    return new Promise(async resolve => {
      $.get({url: `http://120.46.207.10:8193/AA/cronCK/3`, timeout: 30000}, (err, resp, data) => {
        try {
          if (err) {
