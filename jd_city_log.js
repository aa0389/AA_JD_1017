/*
城城领现金
运行一下获取邀请码： export JD_CITY_CODE='你的邀请码'
[task_local]
#城城领现金
...
$.myCodes = process.env.JD_CITY_CODE;
let inviteCodes = ['dXxsKN19FxUyEmOIBtuJuxgWug','-ryUMNBYEj4YAU2QDqaPu6veTKVKT3U']


!(async () => {
    console.log("请填写你的邀请码，变量为：export JD_CITY_CODE='你的邀请码'\n")
    console.log("请填写你的邀请码，变量为：export JD_CITY_CODE='你的邀请码'\n")
    console.log("请填写你的邀请码，变量为：export JD_CITY_CODE='你的邀请码'\n")
    console.log("多余助力会助力作者！\n")
    console.log("入口复制：13:/そ點①點ひ领哯唫！！PAMSx9UqAayG！➯綡✭Dσδδng  \n")
    console.log("请填写你的邀请码，变量为：export JD_CITY_CODE='你的邀请码'\n")
    console.log("请填写你的邀请码，变量为：export JD_CITY_CODE='你的邀请码'\n")
    console.log("请填写你的邀请码，变量为：export JD_CITY_CODE='你的邀请码'\n")
                        ...
                        if (data.code === 0) {
                            if (data.data && data['data']['bizCode'] === 0) {
                                if (data.data && data.data.result.userActBaseInfo.inviteId) {
                                    console.log(`\n【京东账号${$.index}（${$.UserName}）的${$.name}好友互助码】 \n邀请码：${data.data && data.data.result.userActBaseInfo.inviteId}\n`);
...
function shareCodesFormat() {
    return new Promise(async resolve => {
        ...
        let myCodes = [$.myCodes]
        $.newShareCodes = [...new Set([...myCodes,...inviteCodes])];
